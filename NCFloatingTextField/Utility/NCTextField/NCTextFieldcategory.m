...
#import "NCTextFieldcategory.h"

@implementation NCTextFieldcategory
...
/**
 ...
 @Description set place holder text in label
 */
...
/**
 Override First time load this function
 
 @Description This function create a placeholder label , line and imag
 */
-(void)initialization{
...
-(void)addleftImage{
    ...
    theimg.frame = CGRectMake(0, 3, 19, 21);
...
/**
 <#Description#> This function for bottom line of text field
 */
...
/**
 <#Description#> This function is create placeholder label and check left image is null or not , if leftimage is null then set position from zero otherwise add padding
 */
-(void)addPlaceholderLabel{
    ...
    _labelPlaceholder = [[UILabel alloc]initWithFrame:CGRectMake(xpos, 0, self.frame.size.width-xpos, CGRectGetHeight(self.frame))];
    _labelPlaceholder.text = placeHolderText;
    _labelPlaceholder.textAlignment = self.textAlignment;
    _labelPlaceholder.textColor = [UIColor redColor]; //_placeHolderColor;
...
/**
 <#Description#> This function is working when tap on textfiel and text float to upper side

 @param selected animatin of float text upper side
 */
...
/**
 <#Description#> This function is working when text float to bottom side
...
-(void)resignPlaceholder{
    ...
    CGRect frame = CGRectMake(xpos, 0, self.frame.size.width-5, self.frame.size.height);
